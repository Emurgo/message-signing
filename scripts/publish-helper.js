...
const flowFile = 'cardano_message_signing.js.flow';
...
if (process.argv.slice(2)[0] === '-browser' || process.argv.slice(2)[0] === '-asmjs') {
  ...
  const missingFile = 'cardano_message_signing_bg.js';
...
if (process.argv.slice(2)[0] === '-asmjs') {
  ...
  oldPkg.files = [
    ...
    ...oldPkg.files.filter(file => file !== 'cardano_message_signing_bg.wasm')
  ];
}
